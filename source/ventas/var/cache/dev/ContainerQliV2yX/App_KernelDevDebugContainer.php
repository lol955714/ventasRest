...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\VentaController' => 'getVentaControllerService',
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        $b = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~6GG3q2E'] ?? $this->get_1Serializer6GG3q2EService())));
        ...
        $p = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($l, $e, $a, ($this->privates['property_info'] ?? $this->getPropertyInfoService()), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($l), NULL, []);

        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => $b, 2 => $c, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($d, [], $e), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $e), 5 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ValidationExceptionNormalizer($this->parameters['api_platform.exception_to_status']), 6 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\HttpExceptionNormalizer(), 7 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\RuntimeExceptionNormalizer(), 8 => $c, 9 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ErrorNormalizer(), 10 => $b, 11 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $i, NULL, $d, ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), $e), 12 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $j, $d), 13 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($d, true), 14 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 15 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 16 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 17 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $j, $i, $k, $a, $e, $l, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $m), 18 => new \ApiPlatform\Core\GraphQl\Serializer\ItemNormalizer($g, $h, $j, $n, $i, $a, $e, $l, $o, false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f), 19 => new \ApiPlatform\Core\Serializer\ItemNormalizer($g, $h, $j, $i, $a, $e, $l, $o, false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f, $m), 20 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), 23 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 25 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 26 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 27 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 28 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($k, $i, $j), 'page', 'pagination', $f, $a), $f, $i, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], [])))), 29 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 30 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($p, $j, $k), 31 => new \ApiPlatform\Core\GraphQl\Serializer\ObjectNormalizer($p, $j, $n), 32 => $p], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder())), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\FacturaRepository' => ['privates', 'App\\Repository\\FacturaRepository', 'getFacturaRepositoryService', true],
            'App\\Repository\\LineaVentaRepository' => ['privates', 'App\\Repository\\LineaVentaRepository', 'getLineaVentaRepositoryService', true],
            ...
            'App\\Repository\\FacturaRepository' => '?',
            'App\\Repository\\LineaVentaRepository' => '?',
    ...
    /**
     * Gets the private '.1_Serializer~6GG3q2E' shared service.
     *
     * @return \Symfony\Component\Serializer\Serializer
     */
    protected function get_1Serializer6GG3q2EService()
    {
        return $this->privates['.1_Serializer~6GG3q2E'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['property_info'] ?? $this->getPropertyInfoService()))], [0 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder()))]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fhaUXcePIY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Lit5K2MvNr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vSPs933j0F', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('66GR9hyRaV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Q25Nr4JaWI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9m31qSHdio', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NiS3Ns2Jal', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
