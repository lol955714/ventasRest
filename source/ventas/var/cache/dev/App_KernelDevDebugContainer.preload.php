...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerKl5hdbV\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerKl5hdbV/EntityManager_9a5be93.php';
require __DIR__.'/ContainerKl5hdbV/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerKl5hdbV/getValidator_ExpressionService.php';
require __DIR__.'/ContainerKl5hdbV/getValidator_EmailService.php';
require __DIR__.'/ContainerKl5hdbV/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerKl5hdbV/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerKl5hdbV/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerKl5hdbV/getSession_FactoryService.php';
require __DIR__.'/ContainerKl5hdbV/getServicesResetterService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerKl5hdbV/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerKl5hdbV/getSecrets_VaultService.php';
require __DIR__.'/ContainerKl5hdbV/getRouting_LoaderService.php';
require __DIR__.'/ContainerKl5hdbV/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Routes_DefaultService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_RenderDocsService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_ObjectModel_PropertyDescribers_CompoundService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_ObjectModel_PropertyDescribers_ArrayService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_ModelDescribers_ObjectService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Generator_DefaultService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Describers_Route_DefaultService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Describers_OpenapiPhp_DefaultService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Describers_ConfigService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Describers_ApiPlatformService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Controller_SwaggerYamlService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Controller_SwaggerUiService.php';
require __DIR__.'/ContainerKl5hdbV/getNelmioApiDoc_Controller_SwaggerJsonService.php';
require __DIR__.'/ContainerKl5hdbV/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerKl5hdbV/getErrorControllerService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaSubscriberService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerKl5hdbV/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerKl5hdbV/getDebug_ApiPlatform_DataPersisterService.php';
require __DIR__.'/ContainerKl5hdbV/getContainer_GetenvService.php';
require __DIR__.'/ContainerKl5hdbV/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerKl5hdbV/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerKl5hdbV/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerKl5hdbV/getCache_SystemClearerService.php';
require __DIR__.'/ContainerKl5hdbV/getCache_SystemService.php';
require __DIR__.'/ContainerKl5hdbV/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerKl5hdbV/getCache_AppClearerService.php';
require __DIR__.'/ContainerKl5hdbV/getCache_AppService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_ValidatorService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_PaginationService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_UploadTypeService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_SchemaBuilderService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_IterableTypeService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_FieldsBuilderService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_Cache_SubscriptionService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_Action_GraphqlPlaygroundService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_Action_GraphiqlService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Graphql_Action_EntrypointService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerKl5hdbV/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerKl5hdbV/getTemplateControllerService.php';
require __DIR__.'/ContainerKl5hdbV/getRedirectControllerService.php';
require __DIR__.'/ContainerKl5hdbV/getProductoRepositoryService.php';
require __DIR__.'/ContainerKl5hdbV/getLineaVentaRepositoryService.php';
require __DIR__.'/ContainerKl5hdbV/getFacturaRepositoryService.php';
require __DIR__.'/ContainerKl5hdbV/getCategoriaRepositoryService.php';
require __DIR__.'/ContainerKl5hdbV/getVentaControllerService.php';
require __DIR__.'/ContainerKl5hdbV/getProductoControllerService.php';
require __DIR__.'/ContainerKl5hdbV/getCategoriaControllerService.php';
require __DIR__.'/ContainerKl5hdbV/get_Session_DeprecatedService.php';
require __DIR__.'/ContainerKl5hdbV/get_ServiceLocator_XUrKPVUService.php';
require __DIR__.'/ContainerKl5hdbV/get_ServiceLocator_Mx0UMmYService.php';
require __DIR__.'/ContainerKl5hdbV/get_ServiceLocator_HT2Kv93Service.php';
require __DIR__.'/ContainerKl5hdbV/get_ServiceLocator_BRdave9Service.php';
require __DIR__.'/ContainerKl5hdbV/get_ServiceLocator_XVLSGR1Service.php';
require __DIR__.'/ContainerKl5hdbV/get_Container_Private_TwigService.php';
require __DIR__.'/ContainerKl5hdbV/get_Container_Private_SessionService.php';
require __DIR__.'/ContainerKl5hdbV/get_Container_Private_Security_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerKl5hdbV/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerKl5hdbV/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Controller\VentaController';
$classes[] = 'App\Repository\CategoriaRepository';
$classes[] = 'App\Repository\FacturaRepository';
$classes[] = 'App\Repository\LineaVentaRepository';
